...
1. Ask a follow-up question to the USER for the primary objective of the workflow. Remind the user to provide breadcrumbs of the inputs to be used, the output to be generated, and a generalization of the processing to formulate the outputs.
...
1. For each major step identified and analyzed, present the user what how you intended to perform the step and Ask a follow-up question to see confirmation or clarification.
