  ...
  return (
    <section className="border-b border-primary-300/20 relative overflow-hidden">
      ...
      <motion.div
        ...
        animate="visible"
      >
        <motion.div className="flex flex-col items-center gap-6 mb-10" variants={staggerItem}>
          <CursorLogo size={96} className="text-foreground drop-shadow-2xl" />
          <Badge
            variant="outline"
            className="px-5 py-2.5 border-primary-300/30 bg-primary-300/10 text-primary-300 text-sm backdrop-blur-sm"
          >
        ...
        >
          ...
          <br />
          <span className="text-white">Cursor Hub</span>
        </motion.h1>
