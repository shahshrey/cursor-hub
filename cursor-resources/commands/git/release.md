...
# Git Flow Release Branch - Detailed Sequence of Steps

## 1. Version Validation

1. Validate the version format from `$ARGUMENTS`:
...
2. Ensure version is newer than current tag.

3. Analyze commits since last tag to suggest version:
